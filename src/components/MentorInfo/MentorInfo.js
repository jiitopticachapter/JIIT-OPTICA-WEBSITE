        ...
        <div className="mentors">
            <div className="card-container">
                <div className="card">
                    ...
                    <p className="mentor_name">Dr. Anuraj Panwar</p>
                    <p className="mentor_designation">Faculty Advisor</p>
                    <p className="mentor_content">
                    Dr. Anuraj Panwar is currently an Assistant Professor (Senior Grade) in Department of Physics and Material Science, JIIT Noida.He did M.Sc. (2002) and M.Phil. (2004) from Institute of Advanced Studies, CCS University Meerut. In 2010 he completed Ph.D. from IIT Delhi. From Jan 2010 - Jan 2012, he worked as Research Associate with Prof. Karl-Peter Marzlin at St. Francis Xavier University, NS, Canada. In Jan 2012 he moved to Pohang University of Science and Technology, South Korea. Since then (Jan 2012 to Aug 2017) he was the post doctoral research associate there and actively involved in research with Prof. C. M. Ryu. He is a member of Optical Society of America (OSA), Plasma Science Society India (PSSI) and Association of Asia Pacific Physical Societies – Division of Plasma Physics, (AAPPS-DPP).
                    </p>
                </div>
                ...
                <div className="card">
                    ...
                    <p className="mentor_name">Dr. Manoj Tripathi</p>
                ...
                <div className="card">
                    ...
                    <p className="mentor_name">Dr. Ashish Bhatnagar</p>
                    <p className="mentor_designation">Co-Faculty Advisor</p>
                    <p className="mentor_content">
